...
public class EmployeeController {
	...
	private Employee prepareModel(EmployeeBean employeeBean){
		...
		employee.setDetails(employeeBean.getDetails());
		employee.setLink1(employeeBean.getLink1());
		employee.setLink2(employeeBean.getLink2());
	...
	private List<EmployeeBean> prepareListofBean(List<Employee> employees){
		...
		if(employees != null && !employees.isEmpty()){
			...
			for(Employee employee : employees){
				...
				bean.setTitle(employee.getTitle());
				bean.setId(employee.getId());
				bean.setDetails(employee.getDetails());
				bean.setLink1(employee.getLink1());
				bean.setLink2(employee.getLink2());
				beans.add(bean);
			}
		}
		return beans;
